...
<Project 
  ...
  description="The Tiny File System (TFS) is a streamlined file system developed to handle essential file operations 
  like create, read, write, and delete. Incorporating four primary block types – superblock, inode blocks, data blocks, and free blocks – 
  TFS is structured around the use of linked lists for efficient management of free blocks, inodes, and file extents. The most challenging aspect 
  of this project involved management of these linked lists and rigorous error checking, a critical requirement in file system development to 
  ensure data integrity and system consistency. Additionally, I engineered a library functioning as a disk driver, utilizing a file to mimic actual 
  disk storage. This project greatly enhanced my comprehesion of file system architecture, offering hands-on experience in the complexities 
  of designing and maintaining a reliable and efficient file system." 
...
<Project 
  ...
  description="The Memory Simulator, is a Python script designed to emulate the functionalities of a computer's memory system. This simulator
   ...
   dynamics of memory management, deepening my understanding of its intricate processes and the critical role it plays in computing systems. " 
