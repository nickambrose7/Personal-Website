...
- Collaborated with a cross-functional team to deploy **BetterTexter**, an iOS app that allows users to rewrite text messages in multiple different tones and translate texts into various languages within iMessage, achieving over 100 downloads since launch.
...
- Facilitated understanding of key Computer Science principles, including data structures, algorithms, and OOP, tailoring explanations to individual student needs.
